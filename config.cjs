...
const config = {
  // Session & prefix
  SESSION_ID: process.env.SESSION_ID || "Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ~4AFHxRYS",
  ...
  CAPTION: process.env.CAPTION || "Pᴏᴡᴇʀᴇᴅ Bʏ Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ",
  REPO_IMAGE_URL: process.env.REPO_IMAGE_URL || 'https://files.catbox.moe/3hrxbh.jpg',
  NEWSLETTER_CHANNEL_ID: process.env.NEWSLETTER_CHANNEL_ID || '120363369453603973@newsletter',
  REPO_LINK: process.env.REPO_LINK || 'https://github.com/Black-Tappy/SHADOW-XTECH',
  // Auto features
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Sᴛᴀᴛᴜꜱ Vɪᴇᴡᴇᴅ ʙʏ Sʜᴀᴅᴏᴡ Xᴛᴇᴄʜ',
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : "254759000340",
  SUDO_NUMBER: process.env.SUDO_NUMBER ? process.env.SUDO_NUMBER.split(',') : ["254759000340"],
